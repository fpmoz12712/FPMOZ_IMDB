  ...
  <?php include ('./tags/header/top-header.php') ?>
    ...
    <?php include("../backend/includes/dbh.inc.php");?>
    
      <?php 
      $idsDB = dobavi_favorite($_SESSION['id'],$konekcija);
    ...
    <footer>
      Copyright &copy; 2021 Movie Database | IMDb
    ...
    <script type="text/javascript" >
      ...
      const arrayFromPHP = <?php echo json_encode($idsDB); ?>;
      
      arrayFromPHP.forEach(id => {Ctrl.updateFavorite(id.movie_id)});
